...
zombie.setAttribute("src", "./Img/zombie-1.png");
...
// Check if score is greater than 17
function endGame() {
  if (score == 17) {
    window.location.href = "./win-1.html";
  } else {
